...
namespace Error
{
	ERRORS errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(118, "Использование зарезервивованного идентификатора функции _pow()"),
		ERROR_ENTRY(119, "Использование зарезервивованного идентификатора функции _exp()"),
		ERROR_ENTRY(120, "Использование зарезервивованного идентификатора функции _pause()"),
		ERROR_ENTRY(121, "Слишком большая длина идентификатора функции(>5 символов)"),
		ERROR_ENTRY(122, "Использование зарезервированного слова"),
	  ...
	  ERROR_ENTRY(606, "Ошибка в параметрах вызываемой функции"), ERROR_ENTRY_NODEF(607), ERROR_ENTRY_NODEF(608), ERROR_ENTRY_NODEF(609), ERROR_ENTRY_NODEF(610),
	  ...
	  ERROR_ENTRY(706, "Функция _pause() должна вызываться без параметров"), ERROR_ENTRY(707, "Ошибочный тип члена выражения"),\
	  ERROR_ENTRY(708, "Неверный тип данных функции _print"), ERROR_ENTRY(709, "Ошибочное кол-во параметров функии _print"),
